              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                      @if(auth()->user()->role==1){
                     <li class="active"><a href="{{route('admin.createRack')}}"><i class="fa fa-circle-o"></i>Creat Rack</a></li>
                    <li class="active"><a href="{{route('admin.showRacks')}}"><i class="fa fa-circle-o"></i>Show Racks</a></li>
                    @else
                    <li class="active"><a href="{{route('client.showRacks')}}"><i class="fa fa-circle-o"></i>Show Racks</a></li>
                    @endif
                  </ul>
                </li>
              </ul>
